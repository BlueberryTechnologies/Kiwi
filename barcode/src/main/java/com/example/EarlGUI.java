...
public class EarlGUI implements ActionListener{
    ...
    public EarlGUI(){
        ...
        JLabel printerNameLabel = new JLabel("Printer Name: " + printerName);
        JLabel printingLocation = new JLabel("Printing Location: " + generateBarcode.getImageSavePath());
